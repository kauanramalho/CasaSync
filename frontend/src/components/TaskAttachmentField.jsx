  ...
  return (
    <div className="md:col-span-2">
      ...
      <div className="rounded-[22px] border border-slate-100 bg-white/70 p-4">
        <label
          className={`inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-4 py-3 text-sm font-bold text-blush shadow-card transition hover:-translate-y-0.5 hover:bg-rose-50 ${
                ...
                <div key={attachment.id} className="flex min-w-0 flex-col gap-3 rounded-2xl border border-slate-100 bg-surface/80 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2 sm:justify-end">
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-3 py-2 text-xs font-bold text-ink shadow-sm transition hover:bg-blue-50 disabled:opacity-60"
                    >
                    ...
                    <button
                      ...
                      disabled={disabled}
                      className="inline-flex items-center justify-center gap-2 rounded-xl bg-rose-50 px-3 py-2 text-xs font-bold text-rose-600 transition hover:bg-rose-100 disabled:opacity-60"
                    >
            ...
            {pendingFiles.map((file, index) => (
              <div key={`${file.name}-${file.size}-${index}`} className="flex min-w-0 flex-col gap-3 rounded-2xl border border-dashed border-blush/25 bg-rose-50/40 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  disabled={disabled}
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-3 py-2 text-xs font-bold text-rose-600 transition hover:bg-rose-50 disabled:opacity-60"
                >
                  <Trash2 className="h-3.5 w-3.5" />
                  Remover
                </button>
